            ...
            <div class="p-6 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                <header class="mb-4">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-gray-100">
                        {{ __('Tambah Prioritas Kebutuhan') }}
                    </h2>
                </header>

                <!-- Form Tambah Prioritas Kebutuhan -->
                <form action="{{ route('prioritas-kebutuhan.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="prioritas" id="prioritas"
                               ...
                               placeholder="Masukkan Prioritas Kebutuhan" required>
                        @error('prioritas')
